    ...
    if (response.length > 0) {
      ...
      bcrypt.genSalt(10, function(err, salt) {
          ...
          bcrypt.hash(req.body.password, salt, function(err, hash) {            
            var query = "INSERT INTO users (username, email, password_hash, usertype) VALUES (?, ?, ?, ?)"

            connection.query(query, [ req.body.username, req.body.email, hash, req.body.usertype ], function(err, response) {
